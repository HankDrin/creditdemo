package com.creditdemo.generator.mojo;

import com.baomidou.mybatisplus.generator.AutoGenerator;
import com.baomidou.mybatisplus.generator.config.TemplateConfig;
import com.baomidou.mybatisplus.generator.engine.FreemarkerTemplateEngine;
import com.creditdemo.generator.config.DefaultConfigBuilder;
import com.creditdemo.generator.config.MpCodeGeneratorConfig;
...
//        mpg.setStrategy(config.getStrategyConfig());
        ...
        DefaultConfigBuilder defaultConfigBuilder = new DefaultConfigBuilder(config.getPackageConfig(),
                config.getDataSourceConfig(), config.getStrategyConfig(), new TemplateConfig(),
                config.getGlobalConfig());
        mpg.setConfig(defaultConfigBuilder);
        return mpg;
    }
}
